...
from ...models.b_request_client_notification_admin_mode import BRequestClientNotificationAdminMode
...
def _get_kwargs(
    *,
    json_body: BRequestClientNotificationAdminMode,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/ClientNotification/adminMode",
        "json": json_json_body,
    }
