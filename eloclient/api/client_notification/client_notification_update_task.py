...
from ...models.b_request_client_notification_update_task import BRequestClientNotificationUpdateTask
...
def _get_kwargs(
    *,
    json_body: BRequestClientNotificationUpdateTask,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/ClientNotification/updateTask",
        "json": json_json_body,
    }
