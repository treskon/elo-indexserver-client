...
from ...models.b_request_health_check_service_update import BRequestHealthCheckServiceUpdate
...
def _get_kwargs(
    *,
    json_body: BRequestHealthCheckServiceUpdate,
) -> Dict[str, Any]:
    pass
