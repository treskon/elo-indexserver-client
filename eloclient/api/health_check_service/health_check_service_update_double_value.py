...
from ...models.b_request_health_check_service_update_double_value import BRequestHealthCheckServiceUpdateDoubleValue
...
def _get_kwargs(
    *,
    json_body: BRequestHealthCheckServiceUpdateDoubleValue,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/HealthCheckService/updateDoubleValue",
        "json": json_json_body,
    }
