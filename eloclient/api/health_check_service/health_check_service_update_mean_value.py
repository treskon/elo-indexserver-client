...
from ...models.b_request_health_check_service_update_mean_value import BRequestHealthCheckServiceUpdateMeanValue
...
def _get_kwargs(
    *,
    json_body: BRequestHealthCheckServiceUpdateMeanValue,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/HealthCheckService/updateMeanValue",
        "json": json_json_body,
    }
