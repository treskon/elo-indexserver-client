...
from ...models.b_request_health_check_service_update_all import BRequestHealthCheckServiceUpdateAll
...
def _get_kwargs(
    *,
    json_body: BRequestHealthCheckServiceUpdateAll,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/HealthCheckService/updateAll",
        "json": json_json_body,
    }
