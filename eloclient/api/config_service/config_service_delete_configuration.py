...
from ...models.b_request_config_service_delete_configuration import BRequestConfigServiceDeleteConfiguration
...
def _get_kwargs(
    *,
    body: BRequestConfigServiceDeleteConfiguration,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/ConfigService/deleteConfiguration",
    }
