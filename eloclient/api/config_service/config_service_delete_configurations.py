...
from ...models.b_request_config_service_delete_configurations import BRequestConfigServiceDeleteConfigurations
...
def _get_kwargs(
    *,
    body: BRequestConfigServiceDeleteConfigurations,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/ConfigService/deleteConfigurations",
    }
