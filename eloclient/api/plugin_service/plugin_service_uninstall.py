...
from ...models.b_request_plugin_service_uninstall import BRequestPluginServiceUninstall
...
def _get_kwargs(
    *,
    json_body: BRequestPluginServiceUninstall,
) -> Dict[str, Any]:
    pass
