...
from ...models.b_request_package_service_delete_packages import BRequestPackageServiceDeletePackages
...
def _get_kwargs(
    *,
    body: BRequestPackageServiceDeletePackages,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/PackageService/deletePackages",
    }
