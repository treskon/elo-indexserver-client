...
from ...models.b_request_ix_service_port_if_checkin_map import BRequestIXServicePortIFCheckinMap
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinMap,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinMap",
        "json": json_json_body,
    }
