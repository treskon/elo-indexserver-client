...
from ...models.b_request_ix_service_port_if_restore_sord import BRequestIXServicePortIFRestoreSord
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFRestoreSord,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/restoreSord",
        "json": json_json_body,
    }
