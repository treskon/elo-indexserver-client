...
from ...models.b_request_ix_service_port_if_lock_archive import BRequestIXServicePortIFLockArchive
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFLockArchive,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/lockArchive",
        "json": json_json_body,
    }
