...
from ...models.b_request_ix_service_port_if_checkin_config_files import BRequestIXServicePortIFCheckinConfigFiles
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinConfigFiles,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinConfigFiles",
        "json": json_json_body,
    }
