...
from ...models.b_request_ix_service_port_if_edit_public_download_urls import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFEditPublicDownloadUrls,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/editPublicDownloadUrls",
        "json": json_json_body,
    }
