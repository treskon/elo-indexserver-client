...
from ...models.b_request_ix_service_port_if_activate_substitution import BRequestIXServicePortIFActivateSubstitution
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFActivateSubstitution,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/activateSubstitution",
        "json": json_json_body,
    }
