...
from ...models.b_request_ix_service_port_if_start_work_flow_2 import BRequestIXServicePortIFStartWorkFlow2
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFStartWorkFlow2,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/startWorkFlow2",
        "json": json_json_body,
    }
