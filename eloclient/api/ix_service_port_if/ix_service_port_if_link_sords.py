...
from ...models.b_request_ix_service_port_if_link_sords import BRequestIXServicePortIFLinkSords
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFLinkSords,
) -> Dict[str, Any]:
    pass
