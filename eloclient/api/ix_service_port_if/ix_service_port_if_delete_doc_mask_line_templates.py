...
from ...models.b_request_ix_service_port_if_delete_doc_mask_line_templates import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteDocMaskLineTemplates,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteDocMaskLineTemplates",
        "json": json_json_body,
    }
