...
from ...models.b_request_ix_service_port_if_delete_map_domain import BRequestIXServicePortIFDeleteMapDomain
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteMapDomain,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteMapDomain",
        "json": json_json_body,
    }
