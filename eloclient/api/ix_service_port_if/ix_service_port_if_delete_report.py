...
from ...models.b_request_ix_service_port_if_delete_report import BRequestIXServicePortIFDeleteReport
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteReport,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteReport",
        "json": json_json_body,
    }
