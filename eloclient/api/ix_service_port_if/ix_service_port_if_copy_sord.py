...
from ...models.b_request_ix_service_port_if_copy_sord import BRequestIXServicePortIFCopySord
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCopySord,
) -> Dict[str, Any]:
    pass
