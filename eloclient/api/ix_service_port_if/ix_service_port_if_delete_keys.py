...
from ...models.b_request_ix_service_port_if_delete_keys import BRequestIXServicePortIFDeleteKeys
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteKeys,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteKeys",
        "json": json_json_body,
    }
