...
from ...models.b_request_ix_service_port_if_terminate_work_flow import BRequestIXServicePortIFTerminateWorkFlow
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFTerminateWorkFlow,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/terminateWorkFlow",
        "json": json_json_body,
    }
