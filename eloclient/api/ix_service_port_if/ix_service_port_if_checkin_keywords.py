...
from ...models.b_request_ix_service_port_if_checkin_keywords import BRequestIXServicePortIFCheckinKeywords
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinKeywords,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinKeywords",
        "json": json_json_body,
    }
