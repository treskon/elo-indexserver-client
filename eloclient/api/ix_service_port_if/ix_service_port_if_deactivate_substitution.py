...
from ...models.b_request_ix_service_port_if_deactivate_substitution import BRequestIXServicePortIFDeactivateSubstitution
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeactivateSubstitution,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deactivateSubstitution",
        "json": json_json_body,
    }
