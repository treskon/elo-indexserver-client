...
from ...models.b_request_ix_service_port_if_checkin_repl_names import BRequestIXServicePortIFCheckinReplNames
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinReplNames,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinReplNames",
        "json": json_json_body,
    }
