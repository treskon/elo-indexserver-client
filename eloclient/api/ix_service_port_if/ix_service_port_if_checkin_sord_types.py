...
from ...models.b_request_ix_service_port_if_checkin_sord_types import BRequestIXServicePortIFCheckinSordTypes
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinSordTypes,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinSordTypes",
        "json": json_json_body,
    }
