...
from ...models.b_request_ix_service_port_if_checkin_aspect import BRequestIXServicePortIFCheckinAspect
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinAspect,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinAspect",
        "json": json_json_body,
    }
