...
from ...models.b_request_ix_service_port_if_checkin_report import BRequestIXServicePortIFCheckinReport
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinReport,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinReport",
        "json": json_json_body,
    }
