...
from ...models.b_request_ix_service_port_if_delete_sord import BRequestIXServicePortIFDeleteSord
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteSord,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteSord",
        "json": json_json_body,
    }
