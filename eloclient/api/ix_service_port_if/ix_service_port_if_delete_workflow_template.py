...
from ...models.b_request_ix_service_port_if_delete_workflow_template import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteWorkflowTemplate,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteWorkflowTemplate",
        "json": json_json_body,
    }
