...
from ...models.b_request_ix_service_port_if_link_sords_2 import BRequestIXServicePortIFLinkSords2
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFLinkSords2,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/linkSords2",
        "json": json_json_body,
    }
