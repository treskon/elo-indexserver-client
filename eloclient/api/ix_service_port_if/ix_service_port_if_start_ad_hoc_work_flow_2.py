...
from ...models.b_request_ix_service_port_if_start_ad_hoc_work_flow_2 import BRequestIXServicePortIFStartAdHocWorkFlow2
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFStartAdHocWorkFlow2,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/startAdHocWorkFlow2",
        "json": json_json_body,
    }
