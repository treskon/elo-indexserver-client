...
from ...models.b_request_ix_service_port_if_defer_work_flow_node import BRequestIXServicePortIFDeferWorkFlowNode
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeferWorkFlowNode,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deferWorkFlowNode",
        "json": json_json_body,
    }
