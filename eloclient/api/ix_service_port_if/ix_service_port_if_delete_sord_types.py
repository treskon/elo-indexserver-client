...
from ...models.b_request_ix_service_port_if_delete_sord_types import BRequestIXServicePortIFDeleteSordTypes
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteSordTypes,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteSordTypes",
        "json": json_json_body,
    }
