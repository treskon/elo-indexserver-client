...
from ...models.b_request_ix_service_port_if_delete_notes import BRequestIXServicePortIFDeleteNotes
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteNotes,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteNotes",
        "json": json_json_body,
    }
