...
from ...models.b_request_ix_service_port_if_admin_mode import BRequestIXServicePortIFAdminMode
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFAdminMode,
) -> Dict[str, Any]:
    pass
