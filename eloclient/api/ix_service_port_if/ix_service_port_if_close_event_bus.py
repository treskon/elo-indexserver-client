...
from ...models.b_request_ix_service_port_if_close_event_bus import BRequestIXServicePortIFCloseEventBus
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCloseEventBus,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/closeEventBus",
        "json": json_json_body,
    }
