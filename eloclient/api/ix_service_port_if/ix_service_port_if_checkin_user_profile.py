...
from ...models.b_request_ix_service_port_if_checkin_user_profile import BRequestIXServicePortIFCheckinUserProfile
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinUserProfile,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinUserProfile",
        "json": json_json_body,
    }
