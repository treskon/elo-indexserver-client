...
from ...models.b_request_ix_service_port_if_checkin_subs import BRequestIXServicePortIFCheckinSubs
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinSubs,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinSubs",
        "json": json_json_body,
    }
