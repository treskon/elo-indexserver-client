...
from ...models.b_request_ix_service_port_if_find_close import BRequestIXServicePortIFFindClose
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFFindClose,
) -> Dict[str, Any]:
    pass
