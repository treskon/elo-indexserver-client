...
from ...models.b_request_ix_service_port_if_checkin_map_domain import BRequestIXServicePortIFCheckinMapDomain
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinMapDomain,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinMapDomain",
        "json": json_json_body,
    }
