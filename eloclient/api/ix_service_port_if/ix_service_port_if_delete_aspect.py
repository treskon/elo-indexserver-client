...
from ...models.b_request_ix_service_port_if_delete_aspect import BRequestIXServicePortIFDeleteAspect
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteAspect,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteAspect",
        "json": json_json_body,
    }
