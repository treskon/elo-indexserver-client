...
from ...models.b_request_ix_service_port_if_delete_users import BRequestIXServicePortIFDeleteUsers
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteUsers,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteUsers",
        "json": json_json_body,
    }
