...
from ...models.b_request_ix_service_port_if_reload_scripts import BRequestIXServicePortIFReloadScripts
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFReloadScripts,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/reloadScripts",
        "json": json_json_body,
    }
