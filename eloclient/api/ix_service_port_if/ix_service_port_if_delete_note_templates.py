...
from ...models.b_request_ix_service_port_if_delete_note_templates import BRequestIXServicePortIFDeleteNoteTemplates
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteNoteTemplates,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteNoteTemplates",
        "json": json_json_body,
    }
