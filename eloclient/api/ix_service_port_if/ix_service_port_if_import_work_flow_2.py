...
from ...models.b_request_ix_service_port_if_import_work_flow_2 import BRequestIXServicePortIFImportWorkFlow2
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFImportWorkFlow2,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/importWorkFlow2",
        "json": json_json_body,
    }
