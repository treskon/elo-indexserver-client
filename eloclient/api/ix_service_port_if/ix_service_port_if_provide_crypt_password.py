...
from ...models.b_request_ix_service_port_if_provide_crypt_password import BRequestIXServicePortIFProvideCryptPassword
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFProvideCryptPassword,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/provideCryptPassword",
        "json": json_json_body,
    }
