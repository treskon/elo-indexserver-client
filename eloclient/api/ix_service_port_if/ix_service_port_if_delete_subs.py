...
from ...models.b_request_ix_service_port_if_delete_subs import BRequestIXServicePortIFDeleteSubs
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteSubs,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteSubs",
        "json": json_json_body,
    }
