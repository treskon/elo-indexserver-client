...
from ...models.b_request_ix_service_port_if_delete_translate_terms import BRequestIXServicePortIFDeleteTranslateTerms
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteTranslateTerms,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteTranslateTerms",
        "json": json_json_body,
    }
