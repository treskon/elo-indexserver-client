...
from ...models.b_request_ix_service_port_if_create_new_encryption_set import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCreateNewEncryptionSet,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/createNewEncryptionSet",
        "json": json_json_body,
    }
