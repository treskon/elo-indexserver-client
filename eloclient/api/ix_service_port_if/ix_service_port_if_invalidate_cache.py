...
from ...models.b_request_ix_service_port_if_invalidate_cache import BRequestIXServicePortIFInvalidateCache
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFInvalidateCache,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/invalidateCache",
        "json": json_json_body,
    }
