...
from ...models.b_request_ix_service_port_if_delete_keywords import BRequestIXServicePortIFDeleteKeywords
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteKeywords,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteKeywords",
        "json": json_json_body,
    }
