...
from ...models.b_request_ix_service_port_if_delete_user_profile import BRequestIXServicePortIFDeleteUserProfile
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteUserProfile,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteUserProfile",
        "json": json_json_body,
    }
