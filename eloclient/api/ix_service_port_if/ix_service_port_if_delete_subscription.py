...
from ...models.b_request_ix_service_port_if_delete_subscription import BRequestIXServicePortIFDeleteSubscription
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteSubscription,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteSubscription",
        "json": json_json_body,
    }
