...
from ...models.b_request_ix_service_port_if_delete_notification import BRequestIXServicePortIFDeleteNotification
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteNotification,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteNotification",
        "json": json_json_body,
    }
