...
from ...models.b_request_ix_service_port_if_run_es_process import BRequestIXServicePortIFRunEsProcess
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFRunEsProcess,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/runEsProcess",
        "json": json_json_body,
    }
