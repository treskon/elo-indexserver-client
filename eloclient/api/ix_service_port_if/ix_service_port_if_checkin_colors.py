...
from ...models.b_request_ix_service_port_if_checkin_colors import BRequestIXServicePortIFCheckinColors
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinColors,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinColors",
        "json": json_json_body,
    }
