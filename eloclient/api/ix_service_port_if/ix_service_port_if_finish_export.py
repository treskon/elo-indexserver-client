...
from ...models.b_request_ix_service_port_if_finish_export import BRequestIXServicePortIFFinishExport
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFFinishExport,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/finishExport",
        "json": json_json_body,
    }
