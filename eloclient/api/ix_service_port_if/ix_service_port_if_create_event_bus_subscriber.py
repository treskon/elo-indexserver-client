...
from ...models.b_request_ix_service_port_if_create_event_bus_subscriber import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCreateEventBusSubscriber,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/createEventBusSubscriber",
        "json": json_json_body,
    }
