...
from ...models.b_request_ix_service_port_if_provide_system_crypt_password import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFProvideSystemCryptPassword,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/provideSystemCryptPassword",
        "json": json_json_body,
    }
