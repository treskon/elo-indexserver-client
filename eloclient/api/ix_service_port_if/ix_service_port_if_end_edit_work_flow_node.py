...
from ...models.b_request_ix_service_port_if_end_edit_work_flow_node import BRequestIXServicePortIFEndEditWorkFlowNode
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFEndEditWorkFlowNode,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/endEditWorkFlowNode",
        "json": json_json_body,
    }
