...
from ...models.b_request_ix_service_port_if_set_session_options import BRequestIXServicePortIFSetSessionOptions
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFSetSessionOptions,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/setSessionOptions",
        "json": json_json_body,
    }
