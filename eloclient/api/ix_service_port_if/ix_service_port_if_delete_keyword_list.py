...
from ...models.b_request_ix_service_port_if_delete_keyword_list import BRequestIXServicePortIFDeleteKeywordList
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteKeywordList,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteKeywordList",
        "json": json_json_body,
    }
