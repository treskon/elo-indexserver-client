...
from ...models.b_request_ix_service_port_if_delete_reminders import BRequestIXServicePortIFDeleteReminders
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteReminders,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteReminders",
        "json": json_json_body,
    }
