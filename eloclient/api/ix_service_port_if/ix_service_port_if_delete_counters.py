...
from ...models.b_request_ix_service_port_if_delete_counters import BRequestIXServicePortIFDeleteCounters
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteCounters,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteCounters",
        "json": json_json_body,
    }
