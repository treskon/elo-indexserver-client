...
from ...models.b_request_ix_service_port_if_begin_forward_workflow_node import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFBeginForwardWorkflowNode,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/beginForwardWorkflowNode",
        "json": json_json_body,
    }
