...
from ...models.b_request_ix_service_port_if_checkin_sord import BRequestIXServicePortIFCheckinSord
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinSord,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinSord",
        "json": json_json_body,
    }
