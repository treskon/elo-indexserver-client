...
from ...models.b_request_ix_service_port_if_delete_user import BRequestIXServicePortIFDeleteUser
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteUser,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteUser",
        "json": json_json_body,
    }
