...
from ...models.b_request_ix_service_port_if_delete_event_bus_listener import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteEventBusListener,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteEventBusListener",
        "json": json_json_body,
    }
