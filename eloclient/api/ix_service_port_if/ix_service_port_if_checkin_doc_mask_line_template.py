...
from ...models.b_request_ix_service_port_if_checkin_doc_mask_line_template import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinDocMaskLineTemplate,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinDocMaskLineTemplate",
        "json": json_json_body,
    }
