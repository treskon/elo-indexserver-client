...
from ...models.b_request_ix_service_port_if_checkin_crypt_infos import BRequestIXServicePortIFCheckinCryptInfos
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinCryptInfos,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinCryptInfos",
        "json": json_json_body,
    }
