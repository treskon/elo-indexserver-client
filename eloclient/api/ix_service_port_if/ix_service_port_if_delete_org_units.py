...
from ...models.b_request_ix_service_port_if_delete_org_units import BRequestIXServicePortIFDeleteOrgUnits
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteOrgUnits,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteOrgUnits",
        "json": json_json_body,
    }
