...
from ...models.b_request_ix_service_port_if_find_first_subscriptions import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFFindFirstSubscriptions,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/findFirstSubscriptions",
        "json": json_json_body,
    }
