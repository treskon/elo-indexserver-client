...
from ...models.b_request_ix_service_port_if_set_scripts_to_debug import BRequestIXServicePortIFSetScriptsToDebug
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFSetScriptsToDebug,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/setScriptsToDebug",
        "json": json_json_body,
    }
