...
from ...models.b_request_ix_service_port_if_find_first_translate_terms import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFFindFirstTranslateTerms,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/findFirstTranslateTerms",
        "json": json_json_body,
    }
