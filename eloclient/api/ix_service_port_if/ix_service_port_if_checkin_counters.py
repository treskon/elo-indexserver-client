...
from ...models.b_request_ix_service_port_if_checkin_counters import BRequestIXServicePortIFCheckinCounters
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinCounters,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinCounters",
        "json": json_json_body,
    }
