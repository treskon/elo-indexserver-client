...
from ...models.b_request_ix_service_port_if_start_ad_hoc_work_flow import BRequestIXServicePortIFStartAdHocWorkFlow
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFStartAdHocWorkFlow,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/startAdHocWorkFlow",
        "json": json_json_body,
    }
