...
from ...models.b_request_ix_service_port_if_set_server_info import BRequestIXServicePortIFSetServerInfo
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFSetServerInfo,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/setServerInfo",
        "json": json_json_body,
    }
