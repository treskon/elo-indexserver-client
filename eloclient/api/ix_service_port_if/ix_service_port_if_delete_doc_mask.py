...
from ...models.b_request_ix_service_port_if_delete_doc_mask import BRequestIXServicePortIFDeleteDocMask
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteDocMask,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteDocMask",
        "json": json_json_body,
    }
