...
from ...models.b_request_ix_service_port_if_send_events import BRequestIXServicePortIFSendEvents
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFSendEvents,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/sendEvents",
        "json": json_json_body,
    }
