...
from ...models.b_request_ix_service_port_if_checkin_keyword_list import BRequestIXServicePortIFCheckinKeywordList
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinKeywordList,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinKeywordList",
        "json": json_json_body,
    }
