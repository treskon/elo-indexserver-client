...
from ...models.b_request_ix_service_port_if_delete_work_flow import BRequestIXServicePortIFDeleteWorkFlow
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteWorkFlow,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteWorkFlow",
        "json": json_json_body,
    }
