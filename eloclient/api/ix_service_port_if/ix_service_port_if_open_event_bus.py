...
from ...models.b_request_ix_service_port_if_open_event_bus import BRequestIXServicePortIFOpenEventBus
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFOpenEventBus,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/openEventBus",
        "json": json_json_body,
    }
