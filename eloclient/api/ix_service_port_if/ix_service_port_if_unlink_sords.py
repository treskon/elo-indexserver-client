...
from ...models.b_request_ix_service_port_if_unlink_sords import BRequestIXServicePortIFUnlinkSords
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFUnlinkSords,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/unlinkSords",
        "json": json_json_body,
    }
