...
from ...models.b_request_ix_service_port_if_cleanup_stop import BRequestIXServicePortIFCleanupStop
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCleanupStop,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/cleanupStop",
        "json": json_json_body,
    }
