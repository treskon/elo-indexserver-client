...
from ...models.b_request_ix_service_port_if_delete_map import BRequestIXServicePortIFDeleteMap
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteMap,
) -> Dict[str, Any]:
    pass
