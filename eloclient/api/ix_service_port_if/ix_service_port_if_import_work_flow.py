...
from ...models.b_request_ix_service_port_if_import_work_flow import BRequestIXServicePortIFImportWorkFlow
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFImportWorkFlow,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/importWorkFlow",
        "json": json_json_body,
    }
