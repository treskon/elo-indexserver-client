...
from ...models.b_request_ix_service_port_if_delete_config_files import BRequestIXServicePortIFDeleteConfigFiles
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteConfigFiles,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteConfigFiles",
        "json": json_json_body,
    }
