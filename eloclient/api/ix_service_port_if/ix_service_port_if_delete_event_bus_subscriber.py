...
from ...models.b_request_ix_service_port_if_delete_event_bus_subscriber import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteEventBusSubscriber,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteEventBusSubscriber",
        "json": json_json_body,
    }
