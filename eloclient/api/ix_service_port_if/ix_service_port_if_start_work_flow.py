...
from ...models.b_request_ix_service_port_if_start_work_flow import BRequestIXServicePortIFStartWorkFlow
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFStartWorkFlow,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/startWorkFlow",
        "json": json_json_body,
    }
