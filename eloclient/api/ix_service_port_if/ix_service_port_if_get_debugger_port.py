...
from ...models.b_request_ix_service_port_if_get_debugger_port import BRequestIXServicePortIFGetDebuggerPort
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFGetDebuggerPort,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/getDebuggerPort",
        "json": json_json_body,
    }
