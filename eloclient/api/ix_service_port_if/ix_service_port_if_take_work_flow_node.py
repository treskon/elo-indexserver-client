...
from ...models.b_request_ix_service_port_if_take_work_flow_node import BRequestIXServicePortIFTakeWorkFlowNode
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFTakeWorkFlowNode,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/takeWorkFlowNode",
        "json": json_json_body,
    }
