...
from ...models.b_request_ix_service_port_if_delete_activity_project import BRequestIXServicePortIFDeleteActivityProject
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDeleteActivityProject,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/deleteActivityProject",
        "json": json_json_body,
    }
