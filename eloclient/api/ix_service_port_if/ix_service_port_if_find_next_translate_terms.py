...
from ...models.b_request_ix_service_port_if_find_next_translate_terms import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFFindNextTranslateTerms,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/findNextTranslateTerms",
        "json": json_json_body,
    }
