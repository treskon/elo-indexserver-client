...
from ...models.b_request_ix_service_port_if_set_server_info_dm import BRequestIXServicePortIFSetServerInfoDM
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFSetServerInfoDM,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/setServerInfoDM",
        "json": json_json_body,
    }
