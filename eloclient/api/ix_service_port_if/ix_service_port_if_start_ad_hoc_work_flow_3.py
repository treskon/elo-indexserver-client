...
from ...models.b_request_ix_service_port_if_start_ad_hoc_work_flow_3 import BRequestIXServicePortIFStartAdHocWorkFlow3
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFStartAdHocWorkFlow3,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/startAdHocWorkFlow3",
        "json": json_json_body,
    }
