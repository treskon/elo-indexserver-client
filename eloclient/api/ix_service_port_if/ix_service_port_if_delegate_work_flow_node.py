...
from ...models.b_request_ix_service_port_if_delegate_work_flow_node import BRequestIXServicePortIFDelegateWorkFlowNode
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFDelegateWorkFlowNode,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/delegateWorkFlowNode",
        "json": json_json_body,
    }
