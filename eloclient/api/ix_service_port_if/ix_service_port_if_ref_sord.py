...
from ...models.b_request_ix_service_port_if_ref_sord import BRequestIXServicePortIFRefSord
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFRefSord,
) -> Dict[str, Any]:
    pass
