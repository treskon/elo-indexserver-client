...
from ...models.b_request_ix_service_port_if_checkin_user import BRequestIXServicePortIFCheckinUser
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinUser,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinUser",
        "json": json_json_body,
    }
