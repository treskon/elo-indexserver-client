...
from ...models.b_request_ix_service_port_if_cleanup_start import BRequestIXServicePortIFCleanupStart
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCleanupStart,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/cleanupStart",
        "json": json_json_body,
    }
