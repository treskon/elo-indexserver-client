...
from ...models.b_request_ix_service_port_if_terminate_public_download_urls import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFTerminatePublicDownloadUrls,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/terminatePublicDownloadUrls",
        "json": json_json_body,
    }
