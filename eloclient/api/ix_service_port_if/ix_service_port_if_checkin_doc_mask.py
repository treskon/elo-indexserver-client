...
from ...models.b_request_ix_service_port_if_checkin_doc_mask import BRequestIXServicePortIFCheckinDocMask
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinDocMask,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinDocMask",
        "json": json_json_body,
    }
