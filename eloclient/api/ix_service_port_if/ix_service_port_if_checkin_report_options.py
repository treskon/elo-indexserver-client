...
from ...models.b_request_ix_service_port_if_checkin_report_options import BRequestIXServicePortIFCheckinReportOptions
...
def _get_kwargs(
    *,
    json_body: BRequestIXServicePortIFCheckinReportOptions,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServicePortIF/checkinReportOptions",
        "json": json_json_body,
    }
