...
from ...models.b_request_feed_notification_update_action import BRequestFeedNotificationUpdateAction
...
def _get_kwargs(
    *,
    json_body: BRequestFeedNotificationUpdateAction,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/FeedNotification/updateAction",
        "json": json_json_body,
    }
