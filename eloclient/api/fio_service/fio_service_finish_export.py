...
from ...models.b_request_fio_service_finish_export import BRequestFioServiceFinishExport
...
def _get_kwargs(
    *,
    json_body: BRequestFioServiceFinishExport,
) -> Dict[str, Any]:
    pass
