...
from ...models.b_request_feed_service_register_notify import BRequestFeedServiceRegisterNotify
...
def _get_kwargs(
    *,
    json_body: BRequestFeedServiceRegisterNotify,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/FeedService/registerNotify",
        "json": json_json_body,
    }
