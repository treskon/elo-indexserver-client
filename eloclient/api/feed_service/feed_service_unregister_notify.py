...
from ...models.b_request_feed_service_unregister_notify import BRequestFeedServiceUnregisterNotify
...
def _get_kwargs(
    *,
    json_body: BRequestFeedServiceUnregisterNotify,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/FeedService/unregisterNotify",
        "json": json_json_body,
    }
