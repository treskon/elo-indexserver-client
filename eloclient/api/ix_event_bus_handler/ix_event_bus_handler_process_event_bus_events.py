...
from ...models.b_request_ix_event_bus_handler_process_event_bus_events import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXEventBusHandlerProcessEventBusEvents,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXEventBusHandler/processEventBusEvents",
        "json": json_json_body,
    }
