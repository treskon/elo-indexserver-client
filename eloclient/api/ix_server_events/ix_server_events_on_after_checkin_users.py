...
from ...models.b_request_ix_server_events_on_after_checkin_users import BRequestIXServerEventsOnAfterCheckinUsers
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterCheckinUsers,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterCheckinUsers",
        "json": json_json_body,
    }
