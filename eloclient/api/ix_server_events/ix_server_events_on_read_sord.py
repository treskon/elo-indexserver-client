...
from ...models.b_request_ix_server_events_on_read_sord import BRequestIXServerEventsOnReadSord
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnReadSord,
) -> Dict[str, Any]:
    pass
