...
from ...models.b_request_ix_server_events_on_file_upload_build_response import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnFileUploadBuildResponse,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onFileUploadBuildResponse",
        "json": json_json_body,
    }
