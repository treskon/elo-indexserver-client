...
from ...models.b_request_ix_server_events_on_before_checkin_activity import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnBeforeCheckinActivity,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onBeforeCheckinActivity",
        "json": json_json_body,
    }
