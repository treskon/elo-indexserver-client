...
from ...models.b_request_ix_server_events_on_after_start_work_flow import BRequestIXServerEventsOnAfterStartWorkFlow
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterStartWorkFlow,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterStartWorkFlow",
        "json": json_json_body,
    }
