...
from ...models.b_request_ix_server_events_on_before_checkin_notes import BRequestIXServerEventsOnBeforeCheckinNotes
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnBeforeCheckinNotes,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onBeforeCheckinNotes",
        "json": json_json_body,
    }
