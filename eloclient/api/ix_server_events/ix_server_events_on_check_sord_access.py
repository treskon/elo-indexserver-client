...
from ...models.b_request_ix_server_events_on_check_sord_access import BRequestIXServerEventsOnCheckSordAccess
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnCheckSordAccess,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onCheckSordAccess",
        "json": json_json_body,
    }
