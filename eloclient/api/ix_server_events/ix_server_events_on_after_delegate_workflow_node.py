...
from ...models.b_request_ix_server_events_on_after_delegate_workflow_node import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterDelegateWorkflowNode,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterDelegateWorkflowNode",
        "json": json_json_body,
    }
