...
from ...models.b_request_ix_server_events_on_after_checkin_map import BRequestIXServerEventsOnAfterCheckinMap
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterCheckinMap,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterCheckinMap",
        "json": json_json_body,
    }
