...
from ...models.b_request_ix_server_events_on_before_start_work_flow import BRequestIXServerEventsOnBeforeStartWorkFlow
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnBeforeStartWorkFlow,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onBeforeStartWorkFlow",
        "json": json_json_body,
    }
