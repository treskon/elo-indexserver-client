...
from ...models.b_request_ix_server_events_on_after_end_edit_work_flow_node import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterEndEditWorkFlowNode,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterEndEditWorkFlowNode",
        "json": json_json_body,
    }
