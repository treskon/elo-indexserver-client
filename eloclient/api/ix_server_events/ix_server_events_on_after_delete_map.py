...
from ...models.b_request_ix_server_events_on_after_delete_map import BRequestIXServerEventsOnAfterDeleteMap
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterDeleteMap,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterDeleteMap",
        "json": json_json_body,
    }
