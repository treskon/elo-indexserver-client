...
from ...models.b_request_ix_server_events_on_after_login import BRequestIXServerEventsOnAfterLogin
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterLogin,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterLogin",
        "json": json_json_body,
    }
