...
from ...models.b_request_ix_server_events_on_before_checkin_sord import BRequestIXServerEventsOnBeforeCheckinSord
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnBeforeCheckinSord,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onBeforeCheckinSord",
        "json": json_json_body,
    }
