...
from ...models.b_request_ix_server_events_on_before_delete_sord import BRequestIXServerEventsOnBeforeDeleteSord
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnBeforeDeleteSord,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onBeforeDeleteSord",
        "json": json_json_body,
    }
