...
from ...models.b_request_ix_server_events_on_before_take_work_flow_node import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnBeforeTakeWorkFlowNode,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onBeforeTakeWorkFlowNode",
        "json": json_json_body,
    }
