...
from ...models.b_request_ix_server_events_on_after_checkin_activity import BRequestIXServerEventsOnAfterCheckinActivity
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterCheckinActivity,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterCheckinActivity",
        "json": json_json_body,
    }
