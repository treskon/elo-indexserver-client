...
from ...models.b_request_ix_server_events_on_after_ref_sord import BRequestIXServerEventsOnAfterRefSord
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterRefSord,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterRefSord",
        "json": json_json_body,
    }
