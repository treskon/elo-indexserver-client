...
from ...models.b_request_ix_server_events_on_before_delegate_workflow_node import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnBeforeDelegateWorkflowNode,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onBeforeDelegateWorkflowNode",
        "json": json_json_body,
    }
