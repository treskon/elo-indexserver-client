...
from ...models.b_request_ix_server_events_on_find_close import BRequestIXServerEventsOnFindClose
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnFindClose,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onFindClose",
        "json": json_json_body,
    }
