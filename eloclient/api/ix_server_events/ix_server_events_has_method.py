...
from ...models.b_request_ix_server_events_has_method import BRequestIXServerEventsHasMethod
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsHasMethod,
) -> Dict[str, Any]:
    pass
