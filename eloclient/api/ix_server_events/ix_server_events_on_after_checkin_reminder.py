...
from ...models.b_request_ix_server_events_on_after_checkin_reminder import BRequestIXServerEventsOnAfterCheckinReminder
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterCheckinReminder,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterCheckinReminder",
        "json": json_json_body,
    }
