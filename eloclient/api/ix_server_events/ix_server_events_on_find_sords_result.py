...
from ...models.b_request_ix_server_events_on_find_sords_result import BRequestIXServerEventsOnFindSordsResult
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnFindSordsResult,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onFindSordsResult",
        "json": json_json_body,
    }
