...
from ...models.b_request_ix_server_events_on_after_checkin_sord import BRequestIXServerEventsOnAfterCheckinSord
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterCheckinSord,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterCheckinSord",
        "json": json_json_body,
    }
