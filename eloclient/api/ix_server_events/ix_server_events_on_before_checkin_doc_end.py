...
from ...models.b_request_ix_server_events_on_before_checkin_doc_end import BRequestIXServerEventsOnBeforeCheckinDocEnd
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnBeforeCheckinDocEnd,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onBeforeCheckinDocEnd",
        "json": json_json_body,
    }
