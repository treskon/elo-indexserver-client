...
from ...models.b_request_ix_server_events_on_after_checkin_notes import BRequestIXServerEventsOnAfterCheckinNotes
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterCheckinNotes,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterCheckinNotes",
        "json": json_json_body,
    }
