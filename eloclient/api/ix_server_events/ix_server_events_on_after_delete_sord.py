...
from ...models.b_request_ix_server_events_on_after_delete_sord import BRequestIXServerEventsOnAfterDeleteSord
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterDeleteSord,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterDeleteSord",
        "json": json_json_body,
    }
