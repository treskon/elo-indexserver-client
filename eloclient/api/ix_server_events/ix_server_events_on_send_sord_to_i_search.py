...
from ...models.b_request_ix_server_events_on_send_sord_to_i_search import BRequestIXServerEventsOnSendSordToISearch
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnSendSordToISearch,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onSendSordToISearch",
        "json": json_json_body,
    }
