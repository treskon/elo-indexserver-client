...
from ...models.b_request_ix_server_events_on_before_find_sords_internal_sql import (
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnBeforeFindSordsInternalSQL,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onBeforeFindSordsInternalSQL",
        "json": json_json_body,
    }
