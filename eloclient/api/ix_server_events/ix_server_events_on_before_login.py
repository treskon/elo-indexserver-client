...
from ...models.b_request_ix_server_events_on_before_login import BRequestIXServerEventsOnBeforeLogin
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnBeforeLogin,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onBeforeLogin",
        "json": json_json_body,
    }
