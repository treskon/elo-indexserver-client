...
from ...models.b_request_ix_server_events_on_send_feed_to_i_search import BRequestIXServerEventsOnSendFeedToISearch
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnSendFeedToISearch,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onSendFeedToISearch",
        "json": json_json_body,
    }
