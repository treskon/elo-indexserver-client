...
from ...models.b_request_ix_server_events_on_after_checkin_doc_end import BRequestIXServerEventsOnAfterCheckinDocEnd
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnAfterCheckinDocEnd,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onAfterCheckinDocEnd",
        "json": json_json_body,
    }
