...
from ...models.b_request_ix_server_events_on_before_ref_sord import BRequestIXServerEventsOnBeforeRefSord
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnBeforeRefSord,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onBeforeRefSord",
        "json": json_json_body,
    }
