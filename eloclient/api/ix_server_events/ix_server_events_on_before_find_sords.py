...
from ...models.b_request_ix_server_events_on_before_find_sords import BRequestIXServerEventsOnBeforeFindSords
...
def _get_kwargs(
    *,
    json_body: BRequestIXServerEventsOnBeforeFindSords,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/IXServerEvents/onBeforeFindSords",
        "json": json_json_body,
    }
