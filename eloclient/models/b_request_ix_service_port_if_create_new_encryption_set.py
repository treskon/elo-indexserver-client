...
T = TypeVar("T", bound="BRequestIXServicePortIFCreateNewEncryptionSet")


@_attrs_define
class BRequestIXServicePortIFCreateNewEncryptionSet:
    """
    Attributes:
        ...
        crypt_info (Union[Unset, CryptInfo]): This class defines an encryption set.
    """

    unlock_z: Union[Unset, "LockZ"] = UNSET
    ci: Union[Unset, "ClientInfo"] = UNSET
    crypt_info: Union[Unset, "CryptInfo"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if crypt_info is not UNSET:
            field_dict["cryptInfo"] = crypt_info
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _crypt_info = d.pop("cryptInfo", UNSET)
        crypt_info: Union[Unset, CryptInfo]
        if isinstance(_crypt_info, Unset):
            crypt_info = UNSET
        else:
            crypt_info = CryptInfo.from_dict(_crypt_info)

        b_request_ix_service_port_if_create_new_encryption_set = cls(
            unlock_z=unlock_z,
            ci=ci,
            crypt_info=crypt_info,
        )

        b_request_ix_service_port_if_create_new_encryption_set.additional_properties = d
        return b_request_ix_service_port_if_create_new_encryption_set
