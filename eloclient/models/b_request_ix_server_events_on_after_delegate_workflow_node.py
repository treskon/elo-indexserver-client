...
T = TypeVar("T", bound="BRequestIXServerEventsOnAfterDelegateWorkflowNode")


@_attrs_define
class BRequestIXServerEventsOnAfterDelegateWorkflowNode:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_server_events_on_after_delegate_workflow_node = cls(
            ec=ec,
            delegate_node_info=delegate_node_info,
            lock_z=lock_z,
        )

        b_request_ix_server_events_on_after_delegate_workflow_node.additional_properties = d
        return b_request_ix_server_events_on_after_delegate_workflow_node
