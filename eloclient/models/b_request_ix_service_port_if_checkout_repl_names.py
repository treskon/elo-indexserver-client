...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckoutReplNames")


@_attrs_define
class BRequestIXServicePortIFCheckoutReplNames:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_checkout_repl_names = cls(
            ci=ci,
            lock_z=lock_z,
        )

        b_request_ix_service_port_if_checkout_repl_names.additional_properties = d
        return b_request_ix_service_port_if_checkout_repl_names
