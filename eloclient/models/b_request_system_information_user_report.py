...
T = TypeVar("T", bound="BRequestSystemInformationUserReport")


@_attrs_define
class BRequestSystemInformationUserReport:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_system_information_user_report = cls(
            ci=ci,
            si=si,
        )

        b_request_system_information_user_report.additional_properties = d
        return b_request_system_information_user_report
