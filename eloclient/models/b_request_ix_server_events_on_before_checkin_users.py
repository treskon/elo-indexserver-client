...
T = TypeVar("T", bound="BRequestIXServerEventsOnBeforeCheckinUsers")


@_attrs_define
class BRequestIXServerEventsOnBeforeCheckinUsers:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_server_events_on_before_checkin_users = cls(
            ec=ec,
        ...
        b_request_ix_server_events_on_before_checkin_users.additional_properties = d
        return b_request_ix_server_events_on_before_checkin_users
