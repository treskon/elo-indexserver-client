...
T = TypeVar("T", bound="BRequestIXServicePortIFDeleteKeys")


@_attrs_define
class BRequestIXServicePortIFDeleteKeys:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_delete_keys = cls(
            unlock_z=unlock_z,
            ci=ci,
            ids=ids,
        )

        b_request_ix_service_port_if_delete_keys.additional_properties = d
        return b_request_ix_service_port_if_delete_keys
