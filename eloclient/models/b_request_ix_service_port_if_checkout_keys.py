...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckoutKeys")


@_attrs_define
class BRequestIXServicePortIFCheckoutKeys:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_checkout_keys = cls(
            ci=ci,
            ids=ids,
            lock_z=lock_z,
        )

        b_request_ix_service_port_if_checkout_keys.additional_properties = d
        return b_request_ix_service_port_if_checkout_keys
