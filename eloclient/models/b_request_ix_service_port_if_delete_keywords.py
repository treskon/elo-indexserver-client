...
T = TypeVar("T", bound="BRequestIXServicePortIFDeleteKeywords")


@_attrs_define
class BRequestIXServicePortIFDeleteKeywords:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_delete_keywords = cls(
            unlock_z=unlock_z,
            ci=ci,
            kwids=kwids,
        )

        b_request_ix_service_port_if_delete_keywords.additional_properties = d
        return b_request_ix_service_port_if_delete_keywords
