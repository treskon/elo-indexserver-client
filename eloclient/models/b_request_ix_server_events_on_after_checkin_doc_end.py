...
T = TypeVar("T", bound="BRequestIXServerEventsOnAfterCheckinDocEnd")


@_attrs_define
class BRequestIXServerEventsOnAfterCheckinDocEnd:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_server_events_on_after_checkin_doc_end = cls(
            ec=ec,
            sord=sord,
            sord_db=sord_db,
        ...
        b_request_ix_server_events_on_after_checkin_doc_end.additional_properties = d
        return b_request_ix_server_events_on_after_checkin_doc_end
