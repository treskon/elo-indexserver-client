...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckoutNotification")


@_attrs_define
class BRequestIXServicePortIFCheckoutNotification:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_checkout_notification = cls(
            ci=ci,
            watch_guid=watch_guid,
            user_guid=user_guid,
        )

        b_request_ix_service_port_if_checkout_notification.additional_properties = d
        return b_request_ix_service_port_if_checkout_notification
