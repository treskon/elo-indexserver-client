    ...
    Constants for notes.
        ...
        Attributes:
            ...
            type_annotation_marker (Union[Unset, int]): Note type: highlighting rectange (filled) on the document.
                <p>
                 If the note is assigned the colour 0xC0C0C0 the note will be interpreted by ELODM. In this case a black
                rectangle
                 will painted on the document, using the note coordinates supplied, if the note ACL does not contain sufficient
                read
                 access rights for the current user. This allows document contact to be blacked out for certain users The
                document
            ...
            color_annotation_marker_dm (Union[Unset, int]): This color is used for notes of type TYPE_ANNOTATION_MARKER to
                specify a black rectangle that is painted on the
