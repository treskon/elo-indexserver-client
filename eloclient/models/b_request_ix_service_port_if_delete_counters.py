...
T = TypeVar("T", bound="BRequestIXServicePortIFDeleteCounters")


@_attrs_define
class BRequestIXServicePortIFDeleteCounters:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_delete_counters = cls(
            unlock_z=unlock_z,
            ci=ci,
            counter_names=counter_names,
        )

        b_request_ix_service_port_if_delete_counters.additional_properties = d
        return b_request_ix_service_port_if_delete_counters
