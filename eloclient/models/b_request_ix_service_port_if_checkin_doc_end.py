...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckinDocEnd")


@_attrs_define
class BRequestIXServicePortIFCheckinDocEnd:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_checkin_doc_end = cls(
            unlock_z=unlock_z,
            sord_z=sord_z,
            ci=ci,
            document=document,
        ...
        b_request_ix_service_port_if_checkin_doc_end.additional_properties = d
        return b_request_ix_service_port_if_checkin_doc_end
