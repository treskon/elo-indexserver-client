...
T = TypeVar("T", bound="BRequestSystemInformationCountDocsInStorePath")


@_attrs_define
class BRequestSystemInformationCountDocsInStorePath:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_system_information_count_docs_in_store_path = cls(
            ci=ci,
            si=si,
        )

        b_request_system_information_count_docs_in_store_path.additional_properties = d
        return b_request_system_information_count_docs_in_store_path
