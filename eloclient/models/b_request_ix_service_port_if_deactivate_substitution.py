...
T = TypeVar("T", bound="BRequestIXServicePortIFDeactivateSubstitution")


@_attrs_define
class BRequestIXServicePortIFDeactivateSubstitution:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_deactivate_substitution = cls(
            unlock_z=unlock_z,
            ci=ci,
            substitution_guid=substitution_guid,
        )

        b_request_ix_service_port_if_deactivate_substitution.additional_properties = d
        return b_request_ix_service_port_if_deactivate_substitution
