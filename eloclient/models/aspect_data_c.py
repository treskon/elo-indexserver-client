...
class AspectDataC:
    ...
    Bit constants for members of Aspect
     ...
     Organisation: ELO Digital Office GmbH
        ...
        Attributes:
            mb_id (Union[Unset, str]): Member bit: Aspect ID.
                DB column: id
            mb_name (Union[Unset, str]): Member bit: Aspect name.
                DB column: name
            ln_name (Union[Unset, int]): Column length: Aspect name.
                DB column: name
            mb_lock_id (Union[Unset, str]): Member bit: User ID that holds a lock on this object.
                DB column: lockid
            mb_translation_key (Union[Unset, str]): Member bit: Translation key.
                DB column: translationkey
            ln_translation_key (Union[Unset, int]): Column length: Translation key.
                DB column: translationkey
