...
class ReportInfoC:
    ...
    <p>
     ...
     <p>
     To enable or disable reporting of actions, action codes have to be transformed into ERP codes first. One ERP code
    can
     ...
     *
        ...
        Attributes:
            ...
            act_client_checkout (Union[Unset, int]): Get document file for editing. This report information is written, if
                IXServicePortIF.
            ...
            act_client_showdoc (Union[Unset, int]): Get document file to display (not to edit). This report information is
                written, if IXServicePortIF.
                checkoutDoc is
                 called without lock.
