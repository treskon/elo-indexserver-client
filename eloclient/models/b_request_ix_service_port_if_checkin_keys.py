...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckinKeys")


@_attrs_define
class BRequestIXServicePortIFCheckinKeys:
    """
    Attributes:
        ...
        key_infos (Union[Unset, List['KeyInfo']]):
    ...
    key_infos: Union[Unset, List["KeyInfo"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        key_infos = []
        _key_infos = d.pop("keyInfos", UNSET)
        for key_infos_item_data in _key_infos or []:
            key_infos_item = KeyInfo.from_dict(key_infos_item_data)
        ...
        b_request_ix_service_port_if_checkin_keys = cls(
            unlock_z=unlock_z,
            key_infos=key_infos,
            ci=ci,
        )

        b_request_ix_service_port_if_checkin_keys.additional_properties = d
        return b_request_ix_service_port_if_checkin_keys
