...
T = TypeVar("T", bound="HashMapToHashTag")


@_attrs_define
class HashMapToHashTag:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        hash_map_to_hash_tag.additional_properties = additional_properties
        return hash_map_to_hash_tag
