...
T = TypeVar("T", bound="BRequestIXServicePortIFDeleteMapDomain")


@_attrs_define
class BRequestIXServicePortIFDeleteMapDomain:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_delete_map_domain = cls(
            unlock_z=unlock_z,
            ci=ci,
            domain_name=domain_name,
        )

        b_request_ix_service_port_if_delete_map_domain.additional_properties = d
        return b_request_ix_service_port_if_delete_map_domain
