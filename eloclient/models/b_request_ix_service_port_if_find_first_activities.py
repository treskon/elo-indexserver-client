...
T = TypeVar("T", bound="BRequestIXServicePortIFFindFirstActivities")
...
class BRequestIXServicePortIFFindFirstActivities:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        find_info: Union[Unset, FindActivityInfo]
        ...
        b_request_ix_service_port_if_find_first_activities.additional_properties = d
        return b_request_ix_service_port_if_find_first_activities
