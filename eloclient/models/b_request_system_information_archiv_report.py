...
T = TypeVar("T", bound="BRequestSystemInformationArchivReport")


@_attrs_define
class BRequestSystemInformationArchivReport:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_system_information_archiv_report = cls(
            ci=ci,
            si=si,
        )

        b_request_system_information_archiv_report.additional_properties = d
        return b_request_system_information_archiv_report
