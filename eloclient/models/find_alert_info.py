...
class FindAlertInfo:
    ...
    RESERVED
        ...
        Attributes:
            ...
            dest_id (Union[Unset, str]): Find alerts sendet to this user, ID or name. Only main administrators can set this
                value to an arbitary user ID.
                Other users can only set one of her or his groups or one of her or his substituted users.
            incl_all (Union[Unset, bool]): Find all notification types. If this member is set, the other members related to
            ...
            incl_others (Union[Unset, bool]): Find all other notifications that are not explicitly listed here. Ignored, if
            ...
            time_iso (Union[Unset, str]): Find notifiations with this create date or in this date range. A date range must
                be separated by "...".
    """
