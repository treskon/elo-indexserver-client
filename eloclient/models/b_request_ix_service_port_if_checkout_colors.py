...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckoutColors")


@_attrs_define
class BRequestIXServicePortIFCheckoutColors:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_checkout_colors = cls(
            ci=ci,
            lock_z=lock_z,
        )

        b_request_ix_service_port_if_checkout_colors.additional_properties = d
        return b_request_ix_service_port_if_checkout_colors
