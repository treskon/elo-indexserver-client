...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckoutSubs")


@_attrs_define
class BRequestIXServicePortIFCheckoutSubs:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_checkout_subs = cls(
            ci=ci,
            lock_z=lock_z,
            user_id=user_id,
        )

        b_request_ix_service_port_if_checkout_subs.additional_properties = d
        return b_request_ix_service_port_if_checkout_subs
