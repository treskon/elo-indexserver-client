...
T = TypeVar("T", bound="BRequestIXServicePortIFFindCompletion")


@_attrs_define
class BRequestIXServicePortIFFindCompletion:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_find_completion = cls(
            max_=max_,
            ci=ci,
            find_info=find_info,
        )

        b_request_ix_service_port_if_find_completion.additional_properties = d
        return b_request_ix_service_port_if_find_completion
