...
T = TypeVar("T", bound="BRequestIXServicePortIFInsertPublicDownload")


@_attrs_define
class BRequestIXServicePortIFInsertPublicDownload:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_insert_public_download = cls(
            opts=opts,
            ci=ci,
        )

        b_request_ix_service_port_if_insert_public_download.additional_properties = d
        return b_request_ix_service_port_if_insert_public_download
