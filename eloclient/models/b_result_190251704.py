...
T = TypeVar("T", bound="BResult190251704")


@_attrs_define
class BResult190251704:
    """
    Attributes:
    ...
    result: Union[Unset, "ContentStream"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        result: Union[Unset, ContentStream]
        if isinstance(_result, Unset):
            result = UNSET
        else:
            result = ContentStream.from_dict(_result)

        exception = d.pop("exception", UNSET)

        b_result_190251704 = cls(
            result=result,
            exception=exception,
        )

        b_result_190251704.additional_properties = d
        return b_result_190251704
