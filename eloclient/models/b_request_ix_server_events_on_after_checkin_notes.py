...
T = TypeVar("T", bound="BRequestIXServerEventsOnAfterCheckinNotes")


@_attrs_define
class BRequestIXServerEventsOnAfterCheckinNotes:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_server_events_on_after_checkin_notes = cls(
            ec=ec,
            notes=notes,
            sords=sords,
            note_c=note_c,
        ...
        b_request_ix_server_events_on_after_checkin_notes.additional_properties = d
        return b_request_ix_server_events_on_after_checkin_notes
