...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckoutReportOptions")


@_attrs_define
class BRequestIXServicePortIFCheckoutReportOptions:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_checkout_report_options = cls(
            ci=ci,
            lock_z=lock_z,
        )

        b_request_ix_service_port_if_checkout_report_options.additional_properties = d
        return b_request_ix_service_port_if_checkout_report_options
