...
if TYPE_CHECKING:
    from ..models.int_value import IntValue


T = TypeVar("T", bound="IntListValue")


@_attrs_define
class IntListValue:
    """A list of integer values which is joined by AND or OR depending on <code>andOperator</code>.
    <br>
     Defaults to an OR-disjunction.

        Attributes:
            value_list (Union[Unset, List['IntValue']]):
            and_operator (Union[Unset, bool]): Connective of list elements (default is OR (=false) ).
    """

    value_list: Union[Unset, List["IntValue"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for componentsschemas_list_of_int_value_item_data in _value_list or []:
            componentsschemas_list_of_int_value_item = IntValue.from_dict(componentsschemas_list_of_int_value_item_data)
        ...
        int_list_value.additional_properties = d
