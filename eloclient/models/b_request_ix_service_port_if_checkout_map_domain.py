...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckoutMapDomain")


@_attrs_define
class BRequestIXServicePortIFCheckoutMapDomain:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_checkout_map_domain = cls(
            ci=ci,
            domain_name=domain_name,
            lock_z=lock_z,
        )

        b_request_ix_service_port_if_checkout_map_domain.additional_properties = d
        return b_request_ix_service_port_if_checkout_map_domain
