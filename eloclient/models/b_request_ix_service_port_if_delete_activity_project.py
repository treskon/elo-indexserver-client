...
T = TypeVar("T", bound="BRequestIXServicePortIFDeleteActivityProject")


@_attrs_define
class BRequestIXServicePortIFDeleteActivityProject:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_delete_activity_project = cls(
            unlock_z=unlock_z,
            ci=ci,
            project_name=project_name,
        )

        b_request_ix_service_port_if_delete_activity_project.additional_properties = d
        return b_request_ix_service_port_if_delete_activity_project
