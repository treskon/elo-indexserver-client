...
T = TypeVar("T", bound="BRequestIXServerEventsOnBeforeCheckinMap")


@_attrs_define
class BRequestIXServerEventsOnBeforeCheckinMap:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_server_events_on_before_checkin_map = cls(
            ec=ec,
        ...
        b_request_ix_server_events_on_before_checkin_map.additional_properties = d
        return b_request_ix_server_events_on_before_checkin_map
