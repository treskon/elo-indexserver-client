...
T = TypeVar("T", bound="BResult1888107655")


@_attrs_define
class BResult1888107655:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_result_1888107655 = cls(
            result=result,
            exception=exception,
        )

        b_result_1888107655.additional_properties = d
        return b_result_1888107655
