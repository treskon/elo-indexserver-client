...
class WorkFlowHeadC:
    ...
    Bit constants for members of WorkFlowHead
     ...
     Organisation: ELO Digital Office GmbH
        ...
        Attributes:
            mb_flow_id (Union[Unset, str]): Member bit: Workflow ID DB column: wfflowid
            mb_t_stamp (Union[Unset, str]): Member bit: Timestamp DB column: wftstamp
            ln_t_stamp (Union[Unset, int]): Column length: Timestamp DB column: wftstamp
            mb_guid (Union[Unset, str]): Member bit: GUID DB column: wfguid
            ln_guid (Union[Unset, int]): Column length: GUID DB column: wfguid
            mb_status (Union[Unset, str]): Member bit: Status, != 0 means deleted DB column: wfstatus
            mb_type (Union[Unset, str]): Member bit: Workflow type.
                DB column: wftype
            mb_act_server_id (Union[Unset, str]): Member bit: The current sever ID (resp.
                replication branch) where the DB column: actserverid
            ln_act_server_id (Union[Unset, int]): Column length: The current sever ID (resp.
                replication branch) where the DB column: actserverid
