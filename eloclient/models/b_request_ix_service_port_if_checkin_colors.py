...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckinColors")


@_attrs_define
class BRequestIXServicePortIFCheckinColors:
    """
    Attributes:
        ...
        colors (Union[Unset, List['ColorData']]):
    """

    unlock_z: Union[Unset, "LockZ"] = UNSET
    ci: Union[Unset, "ClientInfo"] = UNSET
    colors: Union[Unset, List["ColorData"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for colors_item_data in _colors or []:
            colors_item = ColorData.from_dict(colors_item_data)

            colors.append(colors_item)

        b_request_ix_service_port_if_checkin_colors = cls(
            unlock_z=unlock_z,
            ci=ci,
            colors=colors,
        )

        b_request_ix_service_port_if_checkin_colors.additional_properties = d
        return b_request_ix_service_port_if_checkin_colors
