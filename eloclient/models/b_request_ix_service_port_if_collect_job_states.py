...
T = TypeVar("T", bound="BRequestIXServicePortIFCollectJobStates")
...
class BRequestIXServicePortIFCollectJobStates:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_collect_job_states.additional_properties = d
        return b_request_ix_service_port_if_collect_job_states
