...
T = TypeVar("T", bound="BRequestIXServicePortIFDeleteReminders")


@_attrs_define
class BRequestIXServicePortIFDeleteReminders:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_delete_reminders = cls(
            reminder_ids=reminder_ids,
            unlock_z=unlock_z,
            ci=ci,
        )

        b_request_ix_service_port_if_delete_reminders.additional_properties = d
        return b_request_ix_service_port_if_delete_reminders
