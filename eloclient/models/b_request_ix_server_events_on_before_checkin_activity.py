...
T = TypeVar("T", bound="BRequestIXServerEventsOnBeforeCheckinActivity")


@_attrs_define
class BRequestIXServerEventsOnBeforeCheckinActivity:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_server_events_on_before_checkin_activity = cls(
            ec=ec,
            act=act,
            is_new=is_new,
            sord=sord,
        ...
        b_request_ix_server_events_on_before_checkin_activity.additional_properties = d
        return b_request_ix_server_events_on_before_checkin_activity
