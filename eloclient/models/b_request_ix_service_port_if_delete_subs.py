...
T = TypeVar("T", bound="BRequestIXServicePortIFDeleteSubs")


@_attrs_define
class BRequestIXServicePortIFDeleteSubs:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_delete_subs = cls(
            unlock_z=unlock_z,
            ci=ci,
            deps=deps,
        )

        b_request_ix_service_port_if_delete_subs.additional_properties = d
        return b_request_ix_service_port_if_delete_subs
