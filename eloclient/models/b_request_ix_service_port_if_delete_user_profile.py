...
T = TypeVar("T", bound="BRequestIXServicePortIFDeleteUserProfile")


@_attrs_define
class BRequestIXServicePortIFDeleteUserProfile:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_delete_user_profile = cls(
            unlock_z=unlock_z,
            ci=ci,
            user_profile=user_profile,
        )

        b_request_ix_service_port_if_delete_user_profile.additional_properties = d
        return b_request_ix_service_port_if_delete_user_profile
