...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckoutAspects")


@_attrs_define
class BRequestIXServicePortIFCheckoutAspects:
    """
    Attributes:
        aspect_ids (Union[Unset, List[str]]):
    ...
    aspect_ids: Union[Unset, List[str]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        aspect_ids: Union[Unset, List[str]] = UNSET
        if not isinstance(self.aspect_ids, Unset):
        ...
        field_dict.update({})
        if aspect_ids is not UNSET:
            field_dict["aspectIds"] = aspect_ids
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        aspect_ids = cast(List[str], d.pop("aspectIds", UNSET))
        ...
        b_request_ix_service_port_if_checkout_aspects = cls(
        ...
        b_request_ix_service_port_if_checkout_aspects.additional_properties = d
        return b_request_ix_service_port_if_checkout_aspects
