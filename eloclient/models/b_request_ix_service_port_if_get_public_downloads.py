...
T = TypeVar("T", bound="BRequestIXServicePortIFGetPublicDownloads")


@_attrs_define
class BRequestIXServicePortIFGetPublicDownloads:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_get_public_downloads = cls(
            opts=opts,
            ci=ci,
        )

        b_request_ix_service_port_if_get_public_downloads.additional_properties = d
        return b_request_ix_service_port_if_get_public_downloads
