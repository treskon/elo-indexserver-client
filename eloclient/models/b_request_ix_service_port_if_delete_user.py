...
T = TypeVar("T", bound="BRequestIXServicePortIFDeleteUser")


@_attrs_define
class BRequestIXServicePortIFDeleteUser:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_delete_user = cls(
            unlock_z=unlock_z,
            ci=ci,
            id=id,
        )

        b_request_ix_service_port_if_delete_user.additional_properties = d
        return b_request_ix_service_port_if_delete_user
