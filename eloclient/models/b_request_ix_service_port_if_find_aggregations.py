...
T = TypeVar("T", bound="BRequestIXServicePortIFFindAggregations")


@_attrs_define
class BRequestIXServicePortIFFindAggregations:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_find_aggregations = cls(
            ci=ci,
            find_info=find_info,
        )

        b_request_ix_service_port_if_find_aggregations.additional_properties = d
        return b_request_ix_service_port_if_find_aggregations
