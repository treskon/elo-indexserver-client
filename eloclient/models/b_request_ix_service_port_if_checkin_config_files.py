...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckinConfigFiles")


@_attrs_define
class BRequestIXServicePortIFCheckinConfigFiles:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_checkin_config_files = cls(
            unlock_z=unlock_z,
            config_files=config_files,
            ci=ci,
        )

        b_request_ix_service_port_if_checkin_config_files.additional_properties = d
        return b_request_ix_service_port_if_checkin_config_files
