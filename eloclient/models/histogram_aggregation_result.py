...
T = TypeVar("T", bound="HistogramAggregationResult")
...
class HistogramAggregationResult:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        histogram_aggregation_result = cls(
            buckets=buckets,
        )

        histogram_aggregation_result.additional_properties = d
        return histogram_aggregation_result
