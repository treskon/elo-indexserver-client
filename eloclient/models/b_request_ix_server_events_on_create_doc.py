...
T = TypeVar("T", bound="BRequestIXServerEventsOnCreateDoc")


@_attrs_define
class BRequestIXServerEventsOnCreateDoc:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_server_events_on_create_doc = cls(
            ec=ec,
            parent_id=parent_id,
            mask_id=mask_id,
        ...
        b_request_ix_server_events_on_create_doc.additional_properties = d
        return b_request_ix_server_events_on_create_doc
