...
T = TypeVar("T", bound="BRequestIXServerEventsOnAfterCheckinSord")


@_attrs_define
class BRequestIXServerEventsOnAfterCheckinSord:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_server_events_on_after_checkin_sord = cls(
            ec=ec,
            sord=sord,
            sord_db=sord_db,
        ...
        b_request_ix_server_events_on_after_checkin_sord.additional_properties = d
        return b_request_ix_server_events_on_after_checkin_sord
