...
T = TypeVar("T", bound="BRequestIXServerEventsOnAfterStartWorkFlow")


@_attrs_define
class BRequestIXServerEventsOnAfterStartWorkFlow:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_server_events_on_after_start_work_flow = cls(
            ec=ec,
            workflow=workflow,
            sord=sord,
            sord_z=sord_z,
        ...
        b_request_ix_server_events_on_after_start_work_flow.additional_properties = d
        return b_request_ix_server_events_on_after_start_work_flow
