...
T = TypeVar("T", bound="BRequestFeedServiceCheckoutAction")


@_attrs_define
class BRequestFeedServiceCheckoutAction:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_feed_service_checkout_action = cls(
            action_guid=action_guid,
            action_z=action_z,
            ci=ci,
        )

        b_request_feed_service_checkout_action.additional_properties = d
        return b_request_feed_service_checkout_action
