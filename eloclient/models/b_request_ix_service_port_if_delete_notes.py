...
T = TypeVar("T", bound="BRequestIXServicePortIFDeleteNotes")


@_attrs_define
class BRequestIXServicePortIFDeleteNotes:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_delete_notes = cls(
            unlock_z=unlock_z,
            ci=ci,
            note_ids=note_ids,
        )

        b_request_ix_service_port_if_delete_notes.additional_properties = d
        return b_request_ix_service_port_if_delete_notes
