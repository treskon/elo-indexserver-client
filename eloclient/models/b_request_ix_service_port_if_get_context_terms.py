...
T = TypeVar("T", bound="BRequestIXServicePortIFGetContextTerms")


@_attrs_define
class BRequestIXServicePortIFGetContextTerms:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_get_context_terms = cls(
            field=field,
            max_=max_,
            ci=ci,
            find_info=find_info,
        ...
        b_request_ix_service_port_if_get_context_terms.additional_properties = d
        return b_request_ix_service_port_if_get_context_terms
