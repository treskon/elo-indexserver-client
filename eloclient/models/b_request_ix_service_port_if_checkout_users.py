...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckoutUsers")


@_attrs_define
class BRequestIXServicePortIFCheckoutUsers:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_checkout_users = cls(
            ci=ci,
            ids=ids,
        ...
        b_request_ix_service_port_if_checkout_users.additional_properties = d
        return b_request_ix_service_port_if_checkout_users
