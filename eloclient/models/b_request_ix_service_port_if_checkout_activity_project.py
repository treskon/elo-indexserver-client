...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckoutActivityProject")


@_attrs_define
class BRequestIXServicePortIFCheckoutActivityProject:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return b_request_ix_service_port_if_checkout_activity_project
