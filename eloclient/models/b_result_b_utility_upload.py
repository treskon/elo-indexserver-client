...
T = TypeVar("T", bound="BResultBUtilityUpload")


@_attrs_define
class BResultBUtilityUpload:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_result_b_utility_upload = cls(
            result=result,
            exception=exception,
        )

        b_result_b_utility_upload.additional_properties = d
        return b_result_b_utility_upload
