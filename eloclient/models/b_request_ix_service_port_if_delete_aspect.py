...
T = TypeVar("T", bound="BRequestIXServicePortIFDeleteAspect")


@_attrs_define
class BRequestIXServicePortIFDeleteAspect:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_delete_aspect = cls(
            unlock_z=unlock_z,
            ci=ci,
            aspect_id=aspect_id,
        )

        b_request_ix_service_port_if_delete_aspect.additional_properties = d
        return b_request_ix_service_port_if_delete_aspect
