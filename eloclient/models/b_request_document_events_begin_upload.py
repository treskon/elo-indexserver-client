...
T = TypeVar("T", bound="BRequestDocumentEventsBeginUpload")


@_attrs_define
class BRequestDocumentEventsBeginUpload:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_document_events_begin_upload = cls(
            ec=ec,
            rw_info=rw_info,
        )

        b_request_document_events_begin_upload.additional_properties = d
        return b_request_document_events_begin_upload
