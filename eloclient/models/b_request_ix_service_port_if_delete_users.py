...
T = TypeVar("T", bound="BRequestIXServicePortIFDeleteUsers")


@_attrs_define
class BRequestIXServicePortIFDeleteUsers:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_delete_users = cls(
            unlock_z=unlock_z,
            ci=ci,
            ids=ids,
        )

        b_request_ix_service_port_if_delete_users.additional_properties = d
        return b_request_ix_service_port_if_delete_users
