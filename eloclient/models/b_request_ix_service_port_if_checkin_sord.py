...
T = TypeVar("T", bound="BRequestIXServicePortIFCheckinSord")


@_attrs_define
class BRequestIXServicePortIFCheckinSord:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_checkin_sord = cls(
            ci=ci,
            sord=sord,
            sord_z=sord_z,
            unlock_z=unlock_z,
        ...
        b_request_ix_service_port_if_checkin_sord.additional_properties = d
        return b_request_ix_service_port_if_checkin_sord
