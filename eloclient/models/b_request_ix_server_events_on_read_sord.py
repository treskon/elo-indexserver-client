...
T = TypeVar("T", bound="BRequestIXServerEventsOnReadSord")


@_attrs_define
class BRequestIXServerEventsOnReadSord:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_server_events_on_read_sord = cls(
            ec=ec,
            sord=sord,
            sord_z=sord_z,
            doc=doc,
        ...
        b_request_ix_server_events_on_read_sord.additional_properties = d
        return b_request_ix_server_events_on_read_sord
