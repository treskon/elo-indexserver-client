...
T = TypeVar("T", bound="BRequestIXServerEventsOnBeforeFindSords")


@_attrs_define
class BRequestIXServerEventsOnBeforeFindSords:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_server_events_on_before_find_sords = cls(
            ec=ec,
            find_info=find_info,
            sord_z=sord_z,
        )

        b_request_ix_server_events_on_before_find_sords.additional_properties = d
        return b_request_ix_server_events_on_before_find_sords
