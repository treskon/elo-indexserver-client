...
T = TypeVar("T", bound="BRequestIXServicePortIFCreateWorkFlow")


@_attrs_define
class BRequestIXServicePortIFCreateWorkFlow:
    """
    Attributes:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if ci is not UNSET:
            field_dict["ci"] = ci
        if wf_name is not UNSET:
            field_dict["wfName"] = wf_name
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        b_request_ix_service_port_if_create_work_flow = cls(
            ci=ci,
            wf_name=wf_name,
            type_z=type_z,
        )

        b_request_ix_service_port_if_create_work_flow.additional_properties = d
        return b_request_ix_service_port_if_create_work_flow
