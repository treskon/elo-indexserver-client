...
T = TypeVar("T", bound="BRequestIXServerEventsOnBeforeCheckinDocEnd")


@_attrs_define
class BRequestIXServerEventsOnBeforeCheckinDocEnd:
    """
    Attributes:
        ...
        doc (Union[Unset, Document]): Document object with identifier and version arrays for the document and
            attachments.
            <p>
             Copyright: Copyright (c) 2004
             </p>
    ...
    doc: Union[Unset, "Document"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        doc: Union[Unset, Document]
        if isinstance(_doc, Unset):
            doc = UNSET
        else:
            doc = Document.from_dict(_doc)
        ...
        b_request_ix_server_events_on_before_checkin_doc_end = cls(
            ec=ec,
            sord=sord,
            sord_db=sord_db,
        ...
        b_request_ix_server_events_on_before_checkin_doc_end.additional_properties = d
        return b_request_ix_server_events_on_before_checkin_doc_end
