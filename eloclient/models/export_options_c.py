...
class ExportOptionsC:
    """Constants class for the ExportOptions class. Contains constants used when exporting objects from the ELO archive.
    <p>
     ...
     Organisation: ELO Digital Office GmbH
        ...
        Attributes:
            export_all_versions (Union[Unset, str]): Include other versions in the export. The default is to only export the
