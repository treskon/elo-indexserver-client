...
T = TypeVar("T", bound="IndexSearchDoubleValue")


@_attrs_define
class IndexSearchDoubleValue:
    """This class represents a condition to filter aspect data of type {@link IndexValueC#TYPE_DOUBLE}
    in the database.
        ...
        Attributes:
            ...
            operand (Union[Unset, float]): Value on the right side of the operation.
                The left side implicitly is the value in the
                 database.
    """

    operator: Union[Unset, "IndexSearchOperator"] = UNSET
    operand: Union[Unset, float] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        index_search_double_value = cls(
            operator=operator,
            operand=operand,
        )

        index_search_double_value.additional_properties = d
        return index_search_double_value
