...
T = TypeVar("T", bound="BRequestIXServicePortIFGetSearchTerms")


@_attrs_define
class BRequestIXServicePortIFGetSearchTerms:
    """
    Attributes:
        ...
        term_type (Union[Unset, int]):
    """

    ci: Union[Unset, "ClientInfo"] = UNSET
    find_info: Union[Unset, "FindInfo"] = UNSET
    term_type: Union[Unset, int] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        term_type = d.pop("termType", UNSET)

        b_request_ix_service_port_if_get_search_terms = cls(
            ci=ci,
            find_info=find_info,
            term_type=term_type,
        )

        b_request_ix_service_port_if_get_search_terms.additional_properties = d
        return b_request_ix_service_port_if_get_search_terms
